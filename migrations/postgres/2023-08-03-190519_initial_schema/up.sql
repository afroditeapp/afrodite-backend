...
CREATE TABLE IF NOT EXISTS account_permissions(
    ...
    admin_server_maintenance_view_bot_config     BOOLEAN NOT NULL DEFAULT FALSE,
    admin_server_maintenance_view_image_processing_config         BOOLEAN NOT NULL DEFAULT FALSE,
    ...
    admin_server_maintenance_edit_bot_config     BOOLEAN NOT NULL DEFAULT FALSE,
    admin_server_maintenance_edit_image_processing_config         BOOLEAN NOT NULL DEFAULT FALSE,

...
impl AdminBotStringModerationLlmConfig {
    pub fn new(expected_response: String, system_text: String, user_text_template: String) -> AdminBotStringModerationLlmConfig {

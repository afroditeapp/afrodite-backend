...
pub async fn patch_moderation_request_list(configuration: &configuration::Configuration, queue: ModerationQueueType) -> Result<crate::models::ModerationList, Error<PatchModerationRequestListError>> {

...
/// struct for typed errors of method [`get_account_verification_queue_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAccountVerificationQueueStatusError {
    Status401(),
    Status500(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`post_account_verification_queue_item`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostAccountVerificationQueueItemError {
    Status401(),
    Status429(),
    Status500(),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`post_age_verification`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`post_get_dynamic_client_features_config`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostGetDynamicClientFeaturesConfigError {
    Status401(),
    Status500(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`post_set_email_login_enabled`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostSetEmailLoginEnabledError {
    Status401(),
    Status500(),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_account_verification_queue_status(configuration: &configuration::Configuration, ) -> Result<models::AccountVerificationQueueStatus, Error<GetAccountVerificationQueueStatusError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AccountVerificationQueueStatus`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AccountVerificationQueueStatus`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetAccountVerificationQueueStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_email_address_state(configuration: &configuration::Configuration, ) -> Result<models::EmailAddressState, Error<GetEmailAddressStateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EmailAddressState`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EmailAddressState`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn post_account_verification_queue_item(configuration: &configuration::Configuration, account_verification_queue_item: models::AccountVerificationQueueItem) -> Result<models::PostAccountVerificationQueueItemResult, Error<PostAccountVerificationQueueItemError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PostAccountVerificationQueueItemResult`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PostAccountVerificationQueueItemResult`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<PostAccountVerificationQueueItemError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn post_age_verification(configuration: &configuration::Configuration, post_age_verification: models::PostAgeVerification) -> Result<models::PostAgeVerificationResult, Error<PostAgeVerificationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_post_age_verification = post_age_verification;

    let uri_str = format!("{}/account_api/age_verification", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_post_age_verification);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PostAgeVerificationResult`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PostAgeVerificationResult`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn post_get_dynamic_client_features_config(configuration: &configuration::Configuration, dynamic_client_features_config_hash: models::DynamicClientFeaturesConfigHash) -> Result<models::GetDynamicClientFeaturesConfigResult, Error<PostGetDynamicClientFeaturesConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_dynamic_client_features_config_hash = dynamic_client_features_config_hash;

    let uri_str = format!("{}/account_api/dynamic_client_features_config", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_dynamic_client_features_config_hash);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetDynamicClientFeaturesConfigResult`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetDynamicClientFeaturesConfigResult`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<PostGetDynamicClientFeaturesConfigError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_set_email_login_enabled(configuration: &configuration::Configuration, set_email_login_enabled: models::SetEmailLoginEnabled) -> Result<(), Error<PostSetEmailLoginEnabledError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_set_email_login_enabled = set_email_login_enabled;

    let uri_str = format!("{}/account_api/set_email_login_enabled", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_set_email_login_enabled);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostSetEmailLoginEnabledError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

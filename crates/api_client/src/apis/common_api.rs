...
/// struct for typed errors of method [`get_manual_server_maintenance_info_for_another_server`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetManualServerMaintenanceInfoForAnotherServerError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_pending_app_notifications`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetPendingAppNotificationsError {
    Status401(),
    Status500(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`post_delete_pending_app_notifications`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostDeletePendingAppNotificationsError {
    Status401(),
    Status500(),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_manual_server_maintenance_info_for_another_server(configuration: &configuration::Configuration, ) -> Result<models::ManualServerMaintenanceInfoForAnotherServer, Error<GetManualServerMaintenanceInfoForAnotherServerError>> {

    let uri_str = format!("{}/common_api/manual_server_maintenance_info_for_another_server", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ManualServerMaintenanceInfoForAnotherServer`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ManualServerMaintenanceInfoForAnotherServer`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetManualServerMaintenanceInfoForAnotherServerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_pending_app_notifications(configuration: &configuration::Configuration, ) -> Result<Vec<models::PendingAppNotification>, Error<GetPendingAppNotificationsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetPendingAppNotificationsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_automatic_profile_search_get_next_profile_page(configuration: &configuration::Configuration, automatic_profile_search_iterator_session_id: models::AutomaticProfileSearchIteratorSessionId) -> Result<models::ProfilePage, Error<PostAutomaticProfileSearchGetNextProfilePageError>> {
    ...
    let uri_str = format!("{}/common_api/automatic_profile_search/next", configuration.base_path);
...
pub async fn post_automatic_profile_search_reset_profile_paging(configuration: &configuration::Configuration, ) -> Result<models::AutomaticProfileSearchIteratorSessionId, Error<PostAutomaticProfileSearchResetProfilePagingError>> {
    ...
    let uri_str = format!("{}/common_api/automatic_profile_search/reset", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn post_delete_pending_app_notifications(configuration: &configuration::Configuration, pending_app_notification_to_delete: Vec<models::PendingAppNotificationToDelete>) -> Result<(), Error<PostDeletePendingAppNotificationsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostDeletePendingAppNotificationsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_get_next_profile_page(configuration: &configuration::Configuration, profile_iterator_session_id: models::ProfileIteratorSessionId) -> Result<models::ProfilePage, Error<PostGetNextProfilePageError>> {
    ...
    let uri_str = format!("{}/common_api/profile/page/next", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn post_reset_profile_paging(configuration: &configuration::Configuration, ) -> Result<models::ProfileIteratorSessionId, Error<PostResetProfilePagingError>> {
    ...
    let uri_str = format!("{}/common_api/profile/page/reset", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

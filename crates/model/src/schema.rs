...
diesel::table! {
    account_permissions (account_id) {
        ...
        admin_server_maintenance_view_bot_config -> Bool,
        admin_server_maintenance_view_image_processing_config -> Bool,
        ...
        admin_server_maintenance_edit_bot_config -> Bool,
        admin_server_maintenance_edit_image_processing_config -> Bool,

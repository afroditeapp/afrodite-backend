...
diesel::table! {
    account_state (account_id) {
        ...
        account_banned_reason_category -> Nullable<SmallInt>,
...
diesel::table! {
    media_content (id) {
        ...
        moderation_rejected_reason_category -> Nullable<SmallInt>,
...
diesel::table! {
    profile_moderation (account_id, content_type) {
        ...
        state_type -> SmallInt,
        rejected_reason_category -> Nullable<SmallInt>,
...
diesel::table! {
    profile_state (account_id) {
        ...
        max_distance_km_filter -> Nullable<SmallInt>,
        profile_created_time_filter -> Nullable<BigInt>,
        profile_edited_time_filter -> Nullable<BigInt>,
        profile_text_min_characters_filter -> Nullable<SmallInt>,
        profile_text_max_characters_filter -> Nullable<SmallInt>,

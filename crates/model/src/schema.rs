...
diesel::table! {
    account_email_address_history (id) {
        id -> Int8,
        account_id -> Int8,
        old_email -> Nullable<Text>,
...
diesel::table! {
    account_email_change_limits (account_id) {
        account_id -> Int8,
...
diesel::table! {
    account_email_verification_token_time (account_id) {
        account_id -> Int8,
        unix_time -> Int8,
    }
}
...
diesel::table! {
    account_interaction (id) {
        ...
        account_id_recipient -> Nullable<Int8>,
        account_id_block_sender -> Nullable<Int8>,
        account_id_block_recipient -> Nullable<Int8>,
        two_way_block -> Bool,
        message_counter_sender -> Int8,
        message_counter_recipient -> Int8,
...
diesel::table! {
    account_permissions (account_id) {
        ...
        admin_server_reboot -> Bool,
        admin_server_shutdown -> Bool,
...
diesel::table! {
    account_state (account_id) {
        ...
        account_banned_admin_type_number -> Nullable<Int2>,
...
diesel::table! {
    association_membership (account_id_member) {
        account_id_member -> Int8,
...
diesel::table! {
    chat_report_chat_message (report_id) {
        ...
        message_recipient_account_id_uuid -> Bytea,
...
diesel::table! {
    login_session (account_id) {
        ...
        access_token_previous -> Nullable<Bytea>,
...
diesel::joinable!(account_email_address_history -> account_id (account_id));

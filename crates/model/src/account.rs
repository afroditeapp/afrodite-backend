...
define_permissions!(
    ...
    admin_edit_profile_age_range_verified_value,
    admin_edit_profile_name_verified_value,
    ...
    /// software versions.
    admin_server_view_info,
    admin_server_view_bot_config,
    admin_server_view_image_processing_config,
    admin_server_view_server_config,
    ...
    admin_server_edit_server_config,

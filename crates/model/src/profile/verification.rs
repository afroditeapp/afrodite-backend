...
impl InternalVerificationStatusFlags {
    const PROFILE_CONTENT_FACE_VERIFIED: i16 = 0x1;
    const SECURITY_CONTENT_VERIFIED: i16 = 0x2;
    const PROFILE_AGE_RANGE_VERIFIED: i16 = 0x4;
    const PROFILE_NAME_VERIFIED: i16 = 0x8;
}
...
bitflags::bitflags! {
    ...
    pub struct MediaVerificationStatusFlags: i16 {
        ...
        const PROFILE_CONTENT_FACE_VERIFIED = InternalVerificationStatusFlags::PROFILE_CONTENT_FACE_VERIFIED;

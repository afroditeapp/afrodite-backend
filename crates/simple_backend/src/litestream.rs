...
// use simple_backend_config::{file::LitestreamConfig, SimpleBackendConfig};
...
//     pub fn new(config: Arc<SimpleBackendConfig>, litestream_config: LitestreamConfig) -> Self {
//         Self {
//             config,
//             litestream_config,
//             process: None,
...
//         let root = DatabaseRoot::new(self.config.data_dir())

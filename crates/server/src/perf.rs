...
use server_api_account::{
    account::{
        ACCOUNT_ASSOCIATION_COUNTERS_LIST, ACCOUNT_BAN_COUNTERS_LIST,
...
use server_api_media::{
    ...
    media_admin::{
        MEDIA_ADMIN_CONFIG_COUNTERS_LIST, MEDIA_ADMIN_CONTENT_COUNTERS_LIST,
...
use server_api_profile::{
    ...
    profile_admin::{
        ...
        PROFILE_ADMIN_STATISTICS_COUNTERS_LIST, PROFILE_ADMIN_VERIFICATION_COUNTERS_LIST,
    },
};
...
pub static ALL_COUNTERS: &[&CounterCategory] = &[
    ...
    &CounterCategory::new("common_notification", COMMON_NOTIFICATION_COUNTERS_LIST),
    &CounterCategory::new(
    ...
    // Account
    &CounterCategory::new("account_association", ACCOUNT_ASSOCIATION_COUNTERS_LIST),

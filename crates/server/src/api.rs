...
#[openapi(
    paths(
        ...
        media::put_security_image_info,
        media::get_pending_security_image_info,
        media::put_pending_security_image_info,
        media::delete_pending_security_image_info,
    ...
    components(schemas(
        ...
        model::media::PendingSecurityImage,
